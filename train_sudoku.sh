...
echo
uv run Main_PLL.py --filename Sudoku --seed 1 --train_size 100
...
echo
uv run Main_PLL.py --train_size 1000 --One_of_Many True --path_to_data Data_raw/one_of_many/ --filename 1oM --seed 1
...
echo
uv run Main_PLL.py --train_size 10 --HRM 99 --test_size 1000 --path_to_data Data_raw/sudoku-extreme-10-aug-99/ --seed 1
